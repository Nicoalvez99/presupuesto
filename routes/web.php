...
Route::get('/graficos', [RecordController::class, 'index'])->middleware(['auth', 'verified'])->name('graficos');
Route::get('/dashboard', [MontoController::class, 'index'])->middleware(['auth', 'verified'])->name('dashboard');
Route::get('/historial', [MontoController::class, 'indexHistorial'])->middleware(['auth', 'verified'])->name('historial');
...
Route::get('/presupuestos', [MontoController::class, 'indexPresupuesto'])->middleware(['auth', 'verified'])->name('presupuesto');
Route::get('/ingresos-activos', [IngresoController::class, 'indexActivos'])->middleware(['auth', 'verified'])->name('ingresoActivo');
Route::get('/ingresos-pasivos', [IngresoController::class, 'indexPasivos'])->middleware(['auth', 'verified'])->name('ingresoPasivo');
