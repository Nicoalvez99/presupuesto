<script>
                ...
                data.forEach(function (notification) {
                    ...
                    if ($('#toast-interactive' + notification.id).length == 0) {
                        var notificationHtml = `
                                    ...
                                    <div id="notifications-container" class="notification">
                                            ...
                                            <div class="flex">
                                                ...
                                                <input type="hidden" name="_method" value="patch">
                                                    <div class="ms-3 text-sm font-normal">
                                                        ...
                                                        <div class="mb-2 text-sm font-normal">Hola! ${notification.nombre} te ha enviando una solicitud para vinculacion de cuenta.</div>
    ...
    // Llama a la función al cargar la página para mostrar las notificaciones iniciales
