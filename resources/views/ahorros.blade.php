<x-app-layout>
    ...
    <div class="py-12">
        <h4 id="monto" class="text-center text-white text-4xl text-sm-6xl">$</h4>
    ...
    <div class="pb-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg text-center my-2 py-2">
                <button type="button" data-modal-target="gastos-fijos-modal" data-modal-toggle="gastos-fijos-modal" class="px-3 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">+ Agregar</button>
            </div>
        </div>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mx-auto flex items-center w-full max-w-xs px-4 py-2 text-gray-500 rounded-lg shadow dark:text-gray-400" data-aos="fade-up">
                    <div id="toast-default" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
                        ...
                        <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#toast-warning" aria-label="Close">
                            ...
                            <i data-modal-target="ingresos-activos-update{{ $ahorro->descripcion }}" data-modal-toggle="ingresos-activos-update{{ $ahorro->descripcion }}" class="bi bi-pencil-square"></i>
                            <div class="mx-2">
